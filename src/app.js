...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'v35-swiggy-money-food-pricing-flow',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v35-money-ledger-payout-food-pricing',realData:'enabled',commerce:'restaurant-rider-payout-ledgers-food-variant-pricing',razorpay:'v22-locked-unchanged'}));
