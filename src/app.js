...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'v34-franchise-outlet-system',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v34-franchise-outlets',realData:'enabled',commerce:'franchise-outlets-stock-refill-business-requests',razorpay:'v22-locked-unchanged'}));
