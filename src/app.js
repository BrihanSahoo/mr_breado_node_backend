...
app.get('/',(req,res)=>res.json({success:true,message:'Mr Breado Node backend running',apiPrefix,version:'commerce-v18'}));
app.get(`${apiPrefix}/health`,(req,res)=>res.json({success:true,message:'OK',version:'commerce-v18',time:new Date().toISOString()}));
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'commerce-v18',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v18',realData:'enabled',commerce:'seller-add-order-placement-live-tracking-fixed'}));
