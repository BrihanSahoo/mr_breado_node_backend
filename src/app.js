...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'single-brand-enterprise-v41',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v41-complete-outlet-erp-drilldown-dashboard-location-stock-booking',realData:'enabled',commerce:'single-brand-outlet-erp-sales-stock-calendar-contact-booking-rider-assignment',razorpay:'v22-locked-unchanged'}));
