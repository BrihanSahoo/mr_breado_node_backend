...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'single-brand-outlet-v39-complete',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v39-complete-single-brand-outlet-system',realData:'enabled',commerce:'single-brand-outlet-menu-stock-order-delivery-reporting',razorpay:'v22-locked-unchanged'}));
