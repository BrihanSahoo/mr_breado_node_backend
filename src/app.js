...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'single-brand-enterprise-v43',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v43-outlet-dashboard-route-categories-user-outlet-flow-fix',realData:'enabled',commerce:'single-brand-outlet-dashboard-categories-nearest-menu-fix',razorpay:'v22-locked-unchanged'}));
...
const routers=[require('./routes/singleBrandEnterpriseV43'),require('./routes/singleBrandEnterpriseV42'),require('./routes/singleBrandEnterpriseV41'),require('./routes/singleBrandEnterpriseV40'),require('./routes/singleBrandCompleteV39'),require('./routes/singleBrandOutletV38'),require('./routes/franchisePayoutFoodApprovalV36'),require('./routes/swiggyMoneyFlowV35'),require('./routes/franchiseOutletV34'),require('./routes/verificationFoodAdminV33'),require('./routes/premiumReceiptsInvoicesV30'),require('./routes/orderReviewV30'),require('./routes/verificationRidersV32'),require('./routes/verificationAdminV31'),require('./routes/practicalAdminSellerV23'),require('./routes/realSpringFlowV22'),require('./routes/sellerAdminOrdersV19'),require('./routes/commerceV18'),require('./routes/commerceV17'),require('./routes/realDataV16'),require('./routes/featureUpgrade'),require('./routes/auth'),require('./routes/public'),require('./routes/cartOrders'),require('./routes/operations'),require('./routes/admin'),require('./routes/misc'),require('./routes/springCompatibility'),require('./routes/appEndpointCompatibility')]; routers.forEach(r=>app.use(apiPrefix,r));
