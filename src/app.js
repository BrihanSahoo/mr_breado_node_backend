...
app.get('/',(req,res)=>res.json({success:true,message:'Mr Breado Node backend running',apiPrefix,version:'real-data-v16'}));
app.get(`${apiPrefix}/health`,(req,res)=>res.json({success:true,message:'OK',version:'real-data-v16',time:new Date().toISOString()}));
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'real-data-v16',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v16',realData:'enabled'}));
