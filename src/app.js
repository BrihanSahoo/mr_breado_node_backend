...
app.get(`${apiPrefix}/version`,(req,res)=>res.json({success:true,version:'single-brand-enterprise-v40',paymentCreateOrder:'public-direct-route-null-safe',featureUpgrade:'v40-complete-single-brand-enterprise-outlet-system',realData:'enabled',commerce:'single-brand-outlet-manager-sales-stock-calendar-reporting',razorpay:'v22-locked-unchanged'}));
