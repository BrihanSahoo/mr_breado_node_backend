...
router.post(['/payments/create-order','/payment/create-order','/razorpay/create-order','/checkout/razorpay/create-order','/checkout/payment/create-order'], optionalAuth, ah(async(req,res)=>ok(res,await payment.createOrder({amount:req.body.amount||req.body.amountRupees||req.body.total||req.body.payableAmount,amountInPaise:req.body.amountInPaise||req.body.amount_in_paise,orderId:req.body.orderId||req.body.appOrderId,userId:req.user?.id||req.body.userId||req.body.user_id||null,restaurantId:req.body.restaurantId||req.body.restaurant_id||null,sellerId:req.body.sellerId||req.body.seller_id||null,currency:req.body.currency||'INR'}), 'Payment order created')));
router.post(['/payments/verify','/payment/verify','/razorpay/verify','/checkout/razorpay/verify','/checkout/payment/verify'], optionalAuth, ah(async(req,res)=>ok(res,await payment.verify(req.body, req.user || {}),'Payment verified')));
