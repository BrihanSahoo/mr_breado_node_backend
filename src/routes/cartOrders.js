...
router.post('/payments/create-order', requireAuth, ah(async(req,res)=>ok(res,await payment.createOrder({orderId:req.body.orderId||req.body.appOrderId,userId:req.user.id,restaurantId:req.body.restaurantId||req.body.restaurant_id||null,sellerId:req.body.sellerId||req.body.seller_id||null,currency:req.body.currency||'INR'}), 'Payment order created')));
